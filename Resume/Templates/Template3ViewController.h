...
@interface Template3ViewController : UIViewController <MFMailComposeViewControllerDelegate>
...
@property (strong, nonatomic) IBOutlet UIImageView *skilImage;

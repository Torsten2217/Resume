...
@interface Template2ViewController ()

@end

@implementation Template2ViewController
...
- (void)viewDidLoad {
    ...
    myScroll.contentSize = CGSizeMake(self.view.frame.size.width, self.view.frame.size.height);
    myScroll.maximumZoomScale = 4.0;
    myScroll.minimumZoomScale = 0.75;
